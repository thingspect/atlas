...
type DataPointServiceClient interface {
	...
	// List all data points for a device in a [end, start) time range, in descending timestamp order. Data points are generated by devices.
	ListDataPoints(ctx context.Context, in *ListDataPointsRequest, opts ...grpc.CallOption) (*ListDataPointsResponse, error)
	// List the latest data point for each of a device's attributes. Data points are generated by devices.
