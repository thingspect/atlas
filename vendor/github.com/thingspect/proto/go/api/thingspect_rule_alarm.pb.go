...
const file_api_thingspect_rule_alarm_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/thingspect_rule_alarm.proto\x12\x0ethingspect.api\x1a\x1bapi/thingspect_device.proto\x1a\x1bapi/thingspect_status.proto\x1a\x1bbuf/validate/validate.proto\x1a!common/thingspect_datapoint.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xf6\x02\n" +
	"\x04Rule\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x1a\n" +
	"\x06org_id\x18\x02 \x01(\tB\x03\xe0A\x03R\x05orgID\x12\x1d\n" +
	"\x04name\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x05\x18PR\x04name\x12:\n" +
	"\x06status\x18\x04 \x01(\x0e2\x16.thingspect.api.StatusB\n" +
	"\xbaH\a\x82\x01\x04\x18\x03\x18\x06R\x06status\x12'\n" +
	"\n" +
	"device_tag\x18\x05 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\tdeviceTag\x12\x1b\n" +
	"\x04attr\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x18(R\x04attr\x12\x1c\n" +
	"\x04expr\x18\a \x01(\tB\b\xbaH\x05r\x03\x18\x80\bR\x04expr\x12>\n" +
	"\n" +
	"created_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tcreatedAt\x12>\n" +
	"\n" +
	"updated_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAt\"H\n" +
	"\x11CreateRuleRequest\x123\n" +
	"\x04rule\x18\x01 \x01(\v2\x14.thingspect.api.RuleB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x04rule\"-\n" +
	"\x0eGetRuleRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xbaH\x05r\x03\xb0\x01\x01R\x02id\"\x85\x01\n" +
	"\x11UpdateRuleRequest\x123\n" +
	"\x04rule\x18\x01 \x01(\v2\x14.thingspect.api.RuleB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x04rule\x12;\n" +
	...
	"\x05point\x18\x01 \x01(\v2\x1c.thingspect.common.DataPointB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x05point\x123\n" +
	"\x04rule\x18\x02 \x01(\v2\x14.thingspect.api.RuleB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x04rule\"*\n" +
	...
	"\xbaH\a\x82\x01\x04\x18\x03\x18\x06R\x06status\x12;\n" +
	"\x04type\x18\x06 \x01(\x0e2\x19.thingspect.api.AlarmTypeB\f\xbaH\t\x82\x01\x06\x18\x01\x18\x02\x18\x03R\x04type\x12.\n" +
	"\tuser_tags\x18\a \x03(\tB\x11\xbaH\x0e\x92\x01\v\b\x01\x18\x01\"\x05r\x03\x18\xff\x01R\buserTags\x123\n" +
	"\x10subject_template\x18\b \x01(\tB\b\xbaH\x05r\x03\x18\x80\bR\x0fsubjectTemplate\x12-\n" +
	"\rbody_template\x18\t \x01(\tB\b\xbaH\x05r\x03\x18\x80 R\fbodyTemplate\x124\n" +
	"\x0frepeat_interval\x18\n" +
	" \x01(\x05B\v\xbaH\b\x1a\x06\x18\xc0\x9d\x01(\x01R\x0erepeatInterval\x12>\n" +
	"\n" +
	"created_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tcreatedAt\x12>\n" +
	"\n" +
	"updated_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAt\"L\n" +
	"\x12CreateAlarmRequest\x126\n" +
	"\x05alarm\x18\x01 \x01(\v2\x15.thingspect.api.AlarmB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x05alarm\"T\n" +
	"\x0fGetAlarmRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12$\n" +
	"\arule_id\x18\x02 \x01(\tB\v\xe0A\x02\xbaH\x05r\x03\xb0\x01\x01R\x06ruleID\"\x89\x01\n" +
	"\x12UpdateAlarmRequest\x126\n" +
	"\x05alarm\x18\x01 \x01(\v2\x15.thingspect.api.AlarmB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x05alarm\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"W\n" +
	"\x12DeleteAlarmRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12$\n" +
	"\arule_id\x18\x02 \x01(\tB\v\xe0A\x02\xbaH\x05r\x03\xb0\x01\x01R\x06ruleID\"\x7f\n" +
	"\x11ListAlarmsRequest\x12%\n" +
	"\tpage_size\x18\x01 \x01(\x05B\b\xbaH\x05\x1a\x03\x18\xfa\x01R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12$\n" +
	"\arule_id\x18\x03 \x01(\tB\v\xbaH\b\xd8\x01\x01r\x03\xb0\x01\x01R\x06ruleID\"\x8a\x01\n" +
	"\x12ListAlarmsResponse\x12-\n" +
	"\x06alarms\x18\x01 \x03(\v2\x15.thingspect.api.AlarmR\x06alarms\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xf9\x01\n" +
	"\x10TestAlarmRequest\x12=\n" +
	"\x05point\x18\x01 \x01(\v2\x1c.thingspect.common.DataPointB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x05point\x123\n" +
	"\x04rule\x18\x02 \x01(\v2\x14.thingspect.api.RuleB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x04rule\x129\n" +
	"\x06device\x18\x03 \x01(\v2\x16.thingspect.api.DeviceB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x06device\x126\n" +
	"\x05alarm\x18\x04 \x01(\v2\x15.thingspect.api.AlarmB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\x05alarm\"+\n" +
