...
func file_api_thingspect_alert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_thingspect_alert_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Alert); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_thingspect_alert_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_alert_proto_msgTypes[2].Exporter = func(v any, i int) any {
