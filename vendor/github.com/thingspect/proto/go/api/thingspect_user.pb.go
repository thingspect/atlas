...
const file_api_thingspect_user_proto_rawDesc = "" +
	"\n" +
	"\x19api/thingspect_user.proto\x12\x0ethingspect.api\x1a\x19api/thingspect_role.proto\x1a\x1bapi/thingspect_status.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xd5\x03\n" +
	"\x04User\x12\x13\n" +
	...
	"\x05email\x18\x04 \x01(\tB\a\xfaB\x04r\x02`\x01R\x05email\x12\x1d\n" +
	"\x05phone\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18\x10R\x05phone\x12<\n" +
	"\x04role\x18\x06 \x01(\x0e2\x14.thingspect.api.RoleB\x12\xfaB\x0f\x82\x01\f\x18\x03\x18\x06\x18\a\x18\t\x18\f\x18\x0fR\x04role\x12:\n" +
	"\x06status\x18\a \x01(\x0e2\x16.thingspect.api.StatusB\n" +
	...
	"\aapp_key\x18\t \x01(\tB\a\xfaB\x04r\x02\x18-R\x06appKey\x12>\n" +
	"\n" +
	"created_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tcreatedAt\x12>\n" +
	"\n" +
	"updated_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAt\"J\n" +
	"\x11CreateUserRequest\x125\n" +
	"\x04user\x18\x01 \x01(\v2\x14.thingspect.api.UserB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\"-\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x14.thingspect.api.UserB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\x12;\n" +
	...
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\"t\n" +
	...
	"\x03tag\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xff\x01R\x03tag\"\x86\x01\n" +
	"\x11ListUsersResponse\x12*\n" +
	"\x05users\x18\x01 \x03(\v2\x14.thingspect.api.UserR\x05users\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize2\xf7\x05\n" +
	"\vUserService\x12\x9c\x01\n" +
	"\n" +
	"CreateUser\x12!.thingspect.api.CreateUserRequest\x1a\x14.thingspect.api.User\"U\x92A;J9\n" +
	"\x03201\x122\n" +
	"\x16A successful response.\x12\x18\n" +
	"\x16\x1a\x14.thingspect.api.User\x82\xd3\xe4\x93\x02\x11:\x04user\"\t/v1/users\x12W\n" +
	"\aGetUser\x12\x1e.thingspect.api.GetUserRequest\x1a\x14.thingspect.api.User\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/users/{id}\x12\x85\x01\n" +
	"\n" +
	"UpdateUser\x12!.thingspect.api.UpdateUserRequest\x1a\x14.thingspect.api.User\">\x82\xd3\xe4\x93\x028:\x04userZ\x1b:\x04user2\x13/v1/users/{user.id}\x1a\x13/v1/users/{user.id}\x12{\n" +
	"\x12UpdateUserPassword\x12).thingspect.api.UpdateUserPasswordRequest\x1a\x16.google.protobuf.Empty\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\x1a\x17/v1/users/{id}/password\x12\x85\x01\n" +
	"\n" +
	"DeleteUser\x12!.thingspect.api.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"<\x92A#J!\n" +
	"\x03204\x12\x1a\n" +
	"\x16A successful response.\x12\x00\x82\xd3\xe4\x93\x02\x10*\x0e/v1/users/{id}\x12c\n" +
	"\tListUsers\x12 .thingspect.api.ListUsersRequest\x1a!.thingspect.api.ListUsersResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/usersB$Z\"github.com/thingspect/proto/go/apib\x06proto3"
