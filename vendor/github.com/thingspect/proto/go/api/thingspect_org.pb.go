...
var file_api_thingspect_org_proto_rawDesc = []byte{
	...
	0x2f, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x24,
	0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x68, 0x69,
...
func file_api_thingspect_org_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_thingspect_org_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Org); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_thingspect_org_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_org_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_org_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_org_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_org_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_api_thingspect_org_proto_msgTypes[6].Exporter = func(v any, i int) any {
