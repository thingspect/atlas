...
func (mr *MockLoraerMockRecorder) CreateDevice(ctx, uniqID, appKey any) *gomock.Call {
...
func (mr *MockLoraerMockRecorder) CreateGateway(ctx, uniqID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoraerMockRecorder) DeleteDevice(ctx, uniqID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoraerMockRecorder) DeleteGateway(ctx, uniqID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
