...
func (mr *MockOrgerMockRecorder) Create(ctx, org any) *gomock.Call {
...
func (mr *MockOrgerMockRecorder) Delete(ctx, orgID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrgerMockRecorder) List(ctx, lBoundTS, prevID, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrgerMockRecorder) Update(ctx, org any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
