...
func (mr *MockDevicerMockRecorder) Create(ctx, dev any) *gomock.Call {
...
func (mr *MockDevicerMockRecorder) Delete(ctx, devID, orgID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDevicerMockRecorder) List(ctx, orgID, lBoundTS, prevID, limit, tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockDevicer)(nil).List), ctx, orgID, lBoundTS, prevID, limit, tag)
}
...
func (mr *MockDevicerMockRecorder) Read(ctx, devID, orgID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDevicerMockRecorder) Update(ctx, dev any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
